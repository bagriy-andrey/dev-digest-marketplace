...
`site/` is the build output directory published via GitHub Pages (`.github/workflows/pages.yml`). Do not hand-edit files under `site/` — they are regenerated by `site-build.yml`.
