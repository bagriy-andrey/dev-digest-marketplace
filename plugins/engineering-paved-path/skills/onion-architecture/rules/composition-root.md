...
class and wires them together. This is commonly a file named `container.ts`, `app.ts`, or
similar — wherever this codebase wires concrete implementations together.

**Rule:** `new ConcreteAdapter()` belongs in the composition root only. If you write it anywhere else, move it.

## What the Container does

```ts
// <backend-package>/src/<composition-root-location>/container.ts (wherever your composition root lives)
