...
4. **Only imports:** TypeScript stdlib, your shared/domain-contracts package's Zod contracts (if one exists), other domain helpers
...
In practice, many codebases use plain strings + `parseRepoUrl()` instead of value objects —
